...
const JoinCards = () => {
  ...
  return (
    <>
    {
      joinus.map((join, index)=> <article key={index} className="shadow-md shadow-black rounded-lg relative border-black bg-white">
      ...
      <div className=" flex justify-between rounded-md bg-slate-200 mx-6 my-5 px-4 py-2">
